...
public partial class FoodDetailViewModel : BaseViewModel
{
    ...
    {
        // Main Nutrients
        MainNutrients.Add(nutrientFactory.CreateNutrient("Calories", Amount, FoodItem.Calories, "kcal"));
        MainNutrients.Add(nutrientFactory.CreateNutrient("Protein", Amount, FoodItem.Protein, "g"));
        MainNutrients.Add(nutrientFactory.CreateNutrient("Carbohydrates", Amount, FoodItem.Carbohydrate, "g"));
        MainNutrients.Add(nutrientFactory.CreateNutrient("Fiber", Amount, FoodItem.Fiber, "g"));
        MainNutrients.Add(nutrientFactory.CreateNutrient("Sugars", Amount, FoodItem.Sugar, "g"));
        MainNutrients.Add(nutrientFactory.CreateNutrient("Starch", Amount, FoodItem.Starch, "g"));
        MainNutrients.Add(nutrientFactory.CreateNutrient("Fat", Amount, FoodItem.TotalFat, "g"));
        MainNutrients.Add(nutrientFactory.CreateNutrient("SaturatedFat", Amount, FoodItem.TotalSaturatedFat, "g"));
        MainNutrients.Add(nutrientFactory.CreateNutrient("TransFat", Amount, FoodItem.TotalTransFat, "g"));
        MainNutrients.Add(nutrientFactory.CreateNutrient("MonounsaturatedFat", Amount, FoodItem.TotalMonounsaturated, "g"));
        MainNutrients.Add(nutrientFactory.CreateNutrient("PolyunsaturatedFat", Amount, FoodItem.TotalPolyunsaturated, "g"));
